  ...
  return (    
    <>
      <div className='h-screen' >
        <div ref={ref} className='bg-[url(/imgs/main1-mobile.webp)] md:bg-[url(/imgs/main1-tablet.webp)] lg:bg-[url(/imgs/main1-laptop.webp)] xl:bg-[url(/imgs/main1-desktop.webp)] z-[-10] bg-cover 
